...
#[cfg(not(any(feature = "devnet", feature = "interopnet")))]
lazy_static! {
    /// Minimum power of an individual miner to meet the threshold for leader election.
...
lazy_static! {
    /// Minimum power of an individual miner to meet the threshold for leader election.
    pub static ref CONSENSUS_MINER_MIN_POWER: StoragePower = StoragePower::from_i64(2048).unwrap(); // 2k
}

#[cfg(feature = "interopnet")]
lazy_static! {
    /// Minimum power of an individual miner to meet the threshold for leader election.
    pub static ref CONSENSUS_MINER_MIN_POWER: StoragePower = StoragePower::from_i64(2 << 30).unwrap();
}
